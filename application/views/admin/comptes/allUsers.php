                ...
                <div class="box-body">
                    ...
                    <form class="" action="<?= base_url() . 'admin/createAccount' ?>" method="post">
                        <div class="row clearfix mx-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="groupe_sid" class="control-label"><span class="text-danger">*</span>Groupe
                                        de travail
                                    </label>
                                    <select class="browser-default custom-select select2" name="groupe_sid"
                                            id="groupe_sid">
                                        <option disabled selected>Choisissez un groupe</option>
                                        <?php
                                        foreach ($groupes as $value) {
                                            if($value->group_name !='administrateur'){?>
                                                <option value="<?= $value->group_id; ?>" <?= set_select('groupe_sid', $value->group_id) ?>>
                                                    <?= $value->group_name; ?></option>
                                            <?php }} ?>
                                    </select>
                                    <span class="text-danger"><?php echo form_error('groupe_sid'); ?></span>
                                </div>
                            </div>
                        ...
                        foreach ($managers as $value) {
                            if ($value->asset_type != 'administrateur') {
                                ...
                                <tr>
                                    ...
                                    <td class="text-capitalize"><?= $value->group_name; ?></td>
                                    <td class="">
