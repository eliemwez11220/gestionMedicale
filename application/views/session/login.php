                        ...
                        <div class="content">
                            <form method="post" class="form-validate" action="<?= base_url('security/login'); ?>">
                                <div class="text-center">
                                    <h1>Authentification - Santeza</h1>
                                    <small>Veuillez vous identifier en fournissant les identifiants
                                    de connexion pour acceder a l'application.</small>
                                    <a href="<?= base_url(); ?>" class="signup"><i class="fa fa-chevron-circle-left"></i>revenir au site</a>
                                    <hr>
                                    <?php
                                    if (isset($page_error)) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="login-username" class="label-material">Adresse e-mail ou Indentifiant</label>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="logo text-center">
                                <div>
                                    <img src="<?= base_url('ressources/'); ?>logo/santeza.png"
                                         alt="santeza" style="height: 200px">
                                </div>
    ...
    <div class="container-fluid font-weight-bold">
        ...
        <div class="footer-copyright py-3">
            ...
            <div class="text-right">
                ...
                <small>Powered by <a href="https://digitafriza.congoagile.com" target="_blank">Digitafriza Teams</a>. Solutions informatiques !</small>
                <br>
                <small>
                    © 2020 -
                ...
                <br><small>Validate and authorized by <a href="https://www.congoagile.com" target="_blank">Congo Agile Foundation.</a></small>
            </div>
        </div>
        <!--/.Copyright-->
    </div>
