...
class Admin extends CI_Controller
{
    ...
    public function dashboard()
    {
        ...
        //show all users
        $data['managers'] = $this->App_model->get('vue_groupes_users', 'asset_date_created')->result();
    ...
    public function createAccount()
    {
        ...
        if ($this->form_validation->run() && $this->input->post('asset_type') != "" && $this->input->post('asset_email') != "") {
            ...
            $group_sid = $this->input->post('groupe_sid');
    ...
    public function resetPassword()
    {
        ...
        if ($this->App_model->update_data($data_user, 'tb_ca_assets', array('asset_id' => $id_user))) {
            ...
            $this->setNotifie("Réinitialisation effectuée du mot de passe", "success");
    ...
    public function debloquerAgent()
    {
        ...
        if ($this->App_model->update_data( $data_user,'tb_ca_assets', array('asset_id' => $id_user))) {
            ...
            //redirect  with message notifie
            $this->setNotifie("Agent débloqué - compte utilisateur activé avec succès", "success");
            if ($type_compte == "adminsAccount"){
                return redirect(base_url() . 'admin/adminsAccount');
            }
            else{
    ...
    public function updateForm()
    {
        ...
        $data['agents'] = $this->App_model->get_info_by_table_by_id($id, 'vue_groupes_users', 'asset_id');
        $data['managers'] = $this->App_model->get('vue_groupes_users', 'asset_date_created')->result();
        $data['groupes'] = $this->App_model->get('tb_ca_groups', 'group_name')->result();
